...
public class NPC extends Entity {
	...
	public void UIRender(){
		...
		Util.write(name, ((getY() - getMap().getOffSet().getX()) - getMap().getOffSet().getX())*Slot.SIZE - xTraslation, getY()*Slot.SIZE - getMap().getOffSet().getY()*Slot.SIZE - (float)(Slot.SIZE*.3));
	}
